...
<%--    </ul>--%>
    ...
    <p>管理</p>
    <ul>
        <li><a href="StudentListPageServlet?currentPage=1&type=${userBean.type}" tppabs="*" target="showframe">学生管理</a></li>
        <li><a href="cardListServlet?currentPage=1" tppabs="*" target="showframe">成绩管理</a></li>
    </ul>
